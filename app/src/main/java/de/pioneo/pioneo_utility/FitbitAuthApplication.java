...
import de.pioneo.pioutils.fitbit.authentication.AuthenticationConfiguration;
import de.pioneo.pioutils.fitbit.authentication.AuthenticationConfigurationBuilder;
...
public class FitbitAuthApplication extends Application {
    ...
    public static AuthenticationConfiguration generateAuthenticationConfiguration(Context context, Class<? extends Activity> mainActivityClass) {
        ...
        try {
            ...
            String clientId = bundle.getString("de.pioneo.pioneo_utility.CLIENT_ID");
            String redirectUrl = bundle.getString("de.pioneo.pioneo_utility.REDIRECT_URL");
